...
- You may use helper tools or resources on the same MCP server when needed to complete the goal.
- Do not switch to a different MCP server.
- Return `tool_call` or `resource_read` while you still need more delegated execution.
